...
class LockScreenActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Log.d(TAG, "LockScreenActivity started for: ${intent.getStringExtra("packageName")}")
        ...
        setupUI()
        // Delay biometric prompt slightly to ensure UI is ready
        ...
        biometricPrompt = BiometricPrompt(this, executor, object : BiometricPrompt.AuthenticationCallback() {
            override fun onAuthenticationError(errorCode: Int, errString: CharSequence) {
                ...
                if (errorCode == BiometricPrompt.ERROR_NEGATIVE_BUTTON ||
                    ...
                    // User cancelled - go back to home, do NOT unlock
                    Log.d(TAG, "User cancelled - going home without unlocking")
                    goHome()
                    return
                }
                
                // For other errors, show message and retry
                Toast.makeText(
    ...
    private fun onAuthenticationSuccess() {
        ...
        packageName?.let { 
            AppLockerService.onAppUnlocked(it)
            Log.d(TAG, "App unlocked: $it")
        }
    ...
    override fun onBackPressed() {
        // Go to home screen when back is pressed - do NOT unlock
        Log.d(TAG, "Back pressed - going home without unlocking")
        goHome()
    }
